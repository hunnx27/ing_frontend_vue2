...
export default {
  ...
  methods: {
    ...
    goBack(){
      const URI = `/counsel/counselUpdate1`;
  ...
  created() {
    ...
    if(this.reqData!=null){
      this.txt = this.reqData.txt;
      this.qnaItem = this.reqData.qnaItem;
      this.shortOpenYn = this.reqData.shortOpenYn;
      this.images = this.reqData.images;
